 ...
 * <p>版本号：1<p>
 */
public class LoginPresenter<V extends IMainView.LoginCallo> extends BasePresenter<V> {
    public void LoginPresenter(String name, String pass) {
        LoginHttpUtils.getInstance().getdata(CaoJie.BASE_LOGIN, name, pass, new LoginHttpUtils.CallBackooo() {
            @Override
